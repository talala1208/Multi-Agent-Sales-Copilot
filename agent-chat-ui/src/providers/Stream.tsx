...
// 对应 deepagents 的 AsyncTask TypedDict（python/m5/sales_assistant_sandbox、
// deepagents.middleware.async_subagents）— 每个已启动的 genre-researcher 任务一条，
// 以 task_id 为键。
export type AsyncTask = {
  ...
  // 非 deepagents 默认 AsyncTask 的一部分 — 由本项目自定义 start_async_task 工具
  //（python/m5/sales_assistant_sandbox/async_research.py）添加，
  // 使任务列表显示 "Rock"、"Latin" 等而非裸 task ID。
  label?: string;
};
...
export const StreamProvider: React.FC<{ children: ReactNode }> = ({
  ...
  // API 密钥：localStorage 优先，环境变量为后备
